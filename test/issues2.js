...
console.log('\n[오류 2] 미래 전입 예정일의 연도별 거주 판정');
{
  ...
  T('전입 2030-01: 2027년은 비거주 → 공제 9억', ref30[1].jong.persons[0].deduct === 9 * 억, E.won(ref30[1].jong.persons[0].deduct));
  T('전입 2030-01: 2029년도 비거주 → 9억', ref30[3].jong.persons[0].deduct === 9 * 억, E.won(ref30[3].jong.persons[0].deduct));
